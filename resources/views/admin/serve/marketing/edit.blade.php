...
@section('content')
    <div class="box">
        ...
        {{ Form::open(['method'=>$data?'put':'post','files'=>true,
              'route' => ['admin.marketing.'.($data?'update':'store'),
        ...
        <div class="padding-top-sm">
            ...
            <div class=" form-group">
                {{Form::label('top','是否置顶:')}}
                {{Form::radio('top',\App\Marketing::YES,(old_or_new_field('top',$data) ==  \App\Marketing::YES || old_or_new_field('top',$data)==null))}}
                {{Form::label('top','置顶')}}
                {{Form::radio('top',\App\Marketing::NO,old_or_new_field('top',$data) ==  \App\Marketing::NO)}}
                {{Form::label('top','不置顶')}}
            </div>
            <div class=" form-group">
                <label>选择分辨率:</label>
