...
@section('content')
    <div class="box">
        ...
        @if($data->verify_success->property_img_1)
            <div class="row">
                <div class="col-lg-6 col-sm-8  col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach(json_decode($data->verify_success->property_img_1) as $img)
                                        <div class="swiper-slide">
                                            <img src="{{asset('storage/').'/'.$img}}"
                                                 data-src="{{asset('storage/').'/'.$img}}"
                                                 data-magnify="gallery" class="img-responsive">
        ...
        @if($data->verify_success->property_img_2)
            <div class="row">
                <div class="col-lg-6 col-sm-8  col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach(json_decode($data->verify_success->property_img_2) as $img)
                                        <div class="swiper-slide">
                                            <img src="{{asset('storage/').'/'.$img}}"
                                                 data-src="{{asset('storage/').'/'.$img}}"
                                                 data-magnify="gallery" class="img-responsive">
        ...
        @if($data->verify_success->property_img_3)
            <div class="row">
                <div class="col-lg-6 col-sm-8  col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach(json_decode($data->verify_success->property_img_3) as $img)
                                        <div class="swiper-slide">
                                            <img src="{{asset('storage/').'/'.$img}}"
                                                 data-src="{{asset('storage/').'/'.$img}}"
                                                 data-magnify="gallery" class="img-responsive">
        ...
        @endif
        @if($data->verify_success->property_img_4)
            <div class="row">
                <div class="col-lg-6 col-sm-8  col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach(json_decode($data->verify_success->property_img_4) as $img)
                                        <div class="swiper-slide">
                                            <img src="{{asset('storage/').'/'.$img}}"
                                                 data-src="{{asset('storage/').'/'.$img}}"
                                                 data-magnify="gallery" class="img-responsive">
        ...
        @endif
        @if($data->verify_success->property_img_5)
            <div class="row">
                <div class="col-lg-6 col-sm-8  col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach(json_decode($data->verify_success->property_img_5) as $img)
                                        <div class="swiper-slide">
                                            <img src="{{asset('storage/').'/'.$img}}"
                                                 data-src="{{asset('storage/').'/'.$img}}"
                                                 data-magnify="gallery" class="img-responsive">
        ...
        @endif
        @if($data->verify_success->property_img_6)
            <div class="row">
                <div class="col-lg-6 col-sm-8  col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach(json_decode($data->verify_success->property_img_6) as $img)
                                        <div class="swiper-slide">
                                            <img src="{{asset('storage/').'/'.$img}}"
                                                 data-src="{{asset('storage/').'/'.$img}}"
                                                 data-magnify="gallery" class="img-responsive">
        ...
        @if($data->verify_success->property_img_7)
            <div class="row">
                <div class="col-lg-6 col-sm-8  col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach(json_decode($data->verify_success->property_img_7) as $img)
                                        <div class="swiper-slide">
                                            <img src="{{asset('storage/').'/'.$img}}"
                                                 data-src="{{asset('storage/').'/'.$img}}"
                                                 data-magnify="gallery" class="img-responsive">
        ...
        @if($data->verify_success->property_img)
            <div class="row">
                <div class="col-lg-6 col-sm-8  col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach(json_decode($data->verify_success->property_img) as $img)
                                        <div class="swiper-slide">
                                        <img src="{{asset('storage/').'/'.$img}}"
                                             data-src="{{asset('storage/').'/'.$img}}"
                                             data-magnify="gallery" class="img-responsive">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                <img src="{{asset('storage/').'/'.$data->verify_success->alibi_img }}"
                                     data-src="{{asset('storage/').'/'.$data->verify_success->alibi_img}}"
                                     data-magnify="gallery" class="img-responsive"
                                >
                                </div>
                            </div>
